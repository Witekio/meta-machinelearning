...
do_install_append() {
    ...
    install -m 0555 ${STAGING_DIR_HOST}${datadir}/armnn-tensorflow-lite/mobilenet_v1_0.25_224.tflite  ${D}${TESTVECS_INSTALL_DIR}/models
    install -m 0555 ${STAGING_DIR_HOST}${datadir}/armnn-tensorflow-lite/mobilenet_v1_0.25_224_quant.tflite  ${D}${TESTVECS_INSTALL_DIR}/models
    install -m 0555 ${STAGING_DIR_HOST}${datadir}/armnn-tensorflow-lite/mobilenet_v1_1.0_224.tflite  ${D}${TESTVECS_INSTALL_DIR}/models
    install -m 0555 ${STAGING_DIR_HOST}${datadir}/armnn-tensorflow-lite/mobilenet_v1_1.0_224_quant.tflite  ${D}${TESTVECS_INSTALL_DIR}/models

    install -m 0555 ${STAGING_DIR_HOST}${datadir}/armnn-tensorflow-lite/labels.txt  ${D}${TESTVECS_INSTALL_DIR}/models
